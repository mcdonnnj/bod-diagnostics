...
issue](https://github.com/mcdonnnj/bod-diagnostics/issues) in
...
request](https://github.com/mcdonnnj/bod-diagnostics/pulls),
...
```console
cd bod-diagnostics
pyenv virtualenv <python_version_to_use> bod-diagnostics
pyenv local bod-diagnostics
